#!python3
#1204_project_update_spreadsheet.py - Project: Updating a Spreadsheet

#In this project, you’ll write a program to update cells in a spreadsheet of
#produce sales. Your program will look through the spreadsheet, find specific kinds of produce, and update their prices.
...
#column is set to the Excel formula =ROUND(B3*C3, 2), which multiplies the
#cost per pound by the number of pounds sold and rounds the result to the
#nearest cent. With this formula, the cells in the TOTAL column will 
...
#celery, and lemon rows. You can’t do a simple find-and-replace for the price
...
for row in range(2, sheet.max_row + 1): #first row is header
...
#•	 Automatically “clean up” data in spreadsheets. For example, it could use regular expressions to read multiple formats of phone numbers and
