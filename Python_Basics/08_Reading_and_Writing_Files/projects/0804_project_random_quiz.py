#! python3
#0804_project_random_quiz.py - Project: Generating Random Quiz Files
...
for quizNum in range(35):
	...
	for questionNum in range(50):
		...
		quizFile.write('{}. What is the capital of {}?\n'.format(str(questionNum + 1), str(states[questionNum])))
		for i in range(4):
			quizFile.write(' {}. {}\n'.format(str('ABCD'[i]), str(answerOptions[i])))
		quizFile.write('\n')
		
		## Write the answer key to a file.
		answerKeyFile.write('{}. {}\n'.format(str(questionNum + 1), str('ABCD'[answerOptions.index(correctAnswer)])))
	quizFile.close()
	answerKeyFile.close()
